        ...
        <div className="w-1/2 flex justify-center items-center">
          <div className="p-8 bg-white rounded-xl w-full flex flex-col justify-center h-full">
            ...
            <form className="w-full max-w-md mx-auto">
              ...
              <div className="mb-4">
                <button className="w-full py-2 bg-red-500 text-white rounded hover:bg-red-600 focus:outline-none font-poppins" style={{ fontSize: '20px', width: "100%", height: "77px", borderRadius: "50px" }}>Login</button>
              </div>
